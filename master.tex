...
It seems that pileup may have been---or be---part of some of the stuff that's already happened above. While we're working out that wrinkle, a section on standard atlas MC samples:

\section{Preexisting MC sets}
