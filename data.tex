...
The datasets have been retrieved in the \texttt{NTUP\_PHOTON} format, which is streamlined to contain information relevant to photon analyses. The dataset used contains events corresponding to 18.301~fb$^{-1}$ of integrated luminosity.
