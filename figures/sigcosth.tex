...
\draw [anchor= east] (9.95,-0.0816619) node[color=c, rotate=0]{$\text{cos}\,\theta_{\gamma_{1}}$};
...
\draw [anchor= east] (-0.4,6.73711) node[color=c, rotate=90]{$\text{d}\sigma/\text{d}(\text{cos}\,\theta_{\gamma_{1}})$ [pb]};
