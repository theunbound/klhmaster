...
\draw [anchor=north] (1.66667,0.598046) node[scale=.8, color=c, rotate=0]{All};
\draw [anchor=north] (3,0.598046)       node[scale=.8, color=c, rotate=0]{\phantom{H}otx\_cut\phantom{H}};
\draw [anchor=north] (4.33333,0.598046) node[scale=.8, color=c, rotate=0]{phoClean\_cut};
\draw [anchor=north] (5.66667,0.598046) node[scale=.8, color=c, rotate=0]{ID\_cut};
\draw [anchor=north] (7,0.598046)       node[scale=.8, color=c, rotate=0]{kinematics\_cut};
\draw [anchor=north] (8.33333,0.598046) node[scale=.8, color=c, rotate=0]{N\_events};
