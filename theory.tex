...
where the faction is the quark propagator. This relates to the transition amplitude by integrating over all participating momenta, keeping in mind that momenta must be conserved across all propagators and in every vertex.
...
Since the new term in the Lagrangian enters linearly, and is proportional to $\Lambda^{-4}$, we may express the transition probability, which, as noted above, is proportional to the cross section, for a single $qq\rightarrow\gamma\gamma$ event as
\[|\mathcal L_\textit{SM}+\mathcal L_n|^2=
