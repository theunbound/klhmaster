...
\usepackage[twouparticle,noprint,four]{booklet}
\usepackage{amsmath}
...
\usepackage[sorting=none,hyperref=true,backend=biber]{biblatex}
...
\renewcommand{\abstractnamefont}{\small\sffamily\bfseries\color{natgreen}}
...
% Edits! environment
\newlength{\splitrule}
\setlength{\splitrule}{\textwidth}
\addtolength{\splitrule}{\marginparsep}
\addtolength{\splitrule}{2\marginparsep}
\newlength{\madjust}
\setlength{\madjust}{\marginparsep}
\addtolength{\madjust}{\marginparsep}
\newenvironment{edits}[1][]
    {%
%    
%    \marginpar{\phantom{.}
%    
%    \rule{\marginparwidth}{.2pt}
%    
%    \footnotesize\sffamily Big edits
%
%    #1}
%    \noindent\hspace{-\madjust}
%    \rule{\splitrule}{.2pt}
    }{%
%    
%    \marginpar{\phantom{.}
%    
%    \footnotesize\sffamily \raisebox{-1pt}{\rule{\marginparwidth}{.2pt}}}
%    \noindent\hspace{-\madjust}
%    \rule{\splitrule}{.2pt}
}
...
\hyphenation{non--com-pre-hen-sive}
